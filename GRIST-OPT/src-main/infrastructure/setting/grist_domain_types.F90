...
module grist_domain_types
  ...
  type isolated_comm
   integer(i4) :: off_local_e, off_local_v, off_local_t
   integer(i4) :: cnt_local_e, cnt_local_v, cnt_local_t
   integer(i4), allocatable :: output_local_e(:), output_local_v(:), output_local_t(:)
  end type isolated_comm
  ...
  type global_domain
     ...
     type(isolated_comm) :: icomm_write
