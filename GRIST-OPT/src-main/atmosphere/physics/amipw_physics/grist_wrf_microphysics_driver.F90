...
! wrfphys nml
  use grist_wrfphys_nml_module, only: wrfphys_mp_scheme, use_cond, unuse_mp
! wrf module
...
!Added switches for microphysics schemes by wangym
if ((.not.unuse_mp) ) then
...
!------------wym remove mptendence-------------
pstate_wrf%th_phy(1:ncell,1:nLevel,1:1)=th_old(1:ncell,1:nLevel,1:1)
pstate_wrf%moist(1:ncell,1:nLevel,1:1,p_qv)=moist_old(1:ncell,1:nLevel,1:1,p_qv)
!------------------------------------------
