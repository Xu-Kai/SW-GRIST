...
!                   2. Bring grist_gcm_dycore_init into this module
!
...
!----------------------------------------------------------------------------------
 ...
 module grist_gcm_dycore_control_driver
   ...
   use grist_nml_module,     only: model_timestep,dycore_timestep,tracer_timestep,&
                                   nlev, nlevp, ntracer, nmif, nexpdif_level, do_dycore_laplacian_2nd, do_tracer_laplacian_2nd, &
...
! diffusion
   use grist_dycore_diffusion_module,    only: grist_dycore_diffusion_run
! tracer transport
...
! restart
   ...
   private
   public   :: grist_gcm_dycore_init,&
               grist_gcm_dycore_run, &
               grist_gcm_dycore_final
...
!=========================================================
   ...
   subroutine grist_gcm_dycore_init(local_block)
! dycore
...
!     call grist_full_physpkg1_init(local_block, model_timestep)
     ...
     return
  end subroutine grist_gcm_dycore_init

!================================================
!          Major stepping of the model
!================================================

  subroutine grist_gcm_dycore_run(mesh)
! io
...
!    CASE('dycore') ! pure dry core test
      call t_startf("dycore_run")
      call grist_gcm_control_run_dycore(mesh)
      call t_stopf("dycore_run")
...
! 
     ...
     return
  end subroutine grist_gcm_dycore_run
...
!---------------------------------------------------
  ...
  subroutine grist_gcm_control_run_dycore(mesh)
   type(global_domain), intent(inout) :: mesh
    ...
    DO itimestep = istep_beg, istep_end
       ...
       if(do_dycore_laplacian_2nd) call grist_dycore_diffusion_run(mesh, nexpdif_level,ntracer)
  ...
  subroutine grist_gcm_dycore_final(mesh)
...
!io
    ...
    return
  end subroutine grist_gcm_dycore_final

  end module grist_gcm_dycore_control_driver
