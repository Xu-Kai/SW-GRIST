...
! local
      ...
      real(r8)               :: v1v2(3), flag, div_sum, vcl1, vcl2
...
! io
      ...
      integer(i4)          , intent(in)    :: nexpdif
! local
      integer(i4)            :: ie, ilev,cell1, cell2,vcl1,vcl2
      ...
      do ie = 1, mesh%ne_compute
         ...
         do ilev = 1, nexpdif
             ref_tend_laplacian_2nd_at_pc_full_level(ilev,ie) = 4._r8*scalar_smg_eddy_coef_at_edge_full_level(ilev,ie)*&
                                                                  scalar_hwind_laplace_at_edge_full_level(ilev,ie)
#ifdef DCMIP_SUPERCELL
             ref_tend_laplacian_2nd_at_pc_full_level(ilev,ie) = 4._r8*500._r8*&
                                                                  scalar_hwind_laplace_at_edge_full_level(ilev,ie)
#endif
         end do
      end do
...
!
      if(nsponge.gt.0)then ! default should be 5
        ...
        do ie = 1, mesh%ne_compute
           ...
           vcl1 = mesh%vtxCellLeng(cell1)
           vcl2 = mesh%vtxCellLeng(cell2)
! from top to bottom
           do ilev = 1, nsponge
               tend_laplacian_2nd_at_pc_full_level(ilev,ie) = tend_laplacian_2nd_at_pc_full_level(ilev,ie)+ &
                                       ...
                                       0.5_r8*(vcl1+vcl2)*rearth*(7-ilev)*spcoef/6._r8
           end do
        end do
