!===================================================================================================
!
!  Created by LiXiaohan on 19/06/10, adopted from CAM5
!
...
!===================================================================================================
 ...
 module wv_sat_methods
    ...
    integer(i4), parameter :: Invalid_idx = -1
    integer(i4), parameter :: OldGoffGratch_idx = 0
    integer(i4), parameter :: GoffGratch_idx = 1
    integer(i4), parameter :: MurphyKoop_idx = 2
    integer(i4), parameter :: Bolton_idx = 3
...
contains
    ...
    subroutine wv_sat_methods_init(tmelt_in, h2otrip_in, tboil_in, ttrice_in, epsilo_in, errstring)
! io
...
! Purpose: Get saturation specific humidity given pressure and SVP.
...
! Purpose: Get saturation "mass mixing ratio".
...
! Purpose: Calculate SVP over water at a given temperature, and then
...
! Purpose: Calculate SVP over ice at a given temperature, and then
!          calculate and return saturation specific humidity.
...
! Interface:
    ...
    real(r8),     intent(in)           :: t
    integer(i4),  intent(in), optional :: idx
    real(r8)                           :: es
