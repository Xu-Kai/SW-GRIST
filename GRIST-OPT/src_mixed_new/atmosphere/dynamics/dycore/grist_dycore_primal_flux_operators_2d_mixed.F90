...
!          do ilev   = 1, nlev
            ...
            der0 = 2._r8*dot_product(edt_v_weight_prime_cell(1:mesh%plg_stencil_number_2nd(v_upwind), mark, ie), &
               scalar_height_at_pc_full_level(ilev,mesh%plg_stencil_index_2nd(1:mesh%plg_stencil_number_2nd(v_upwind), v_upwind))-scalar_height_at_pc_full_level(ilev,v_upwind))
            
            scalar_normal_flux_at_edge_full_level(ilev,ie) = (scalar_height_at_pc_full_level(ilev,v1)+scalar_height_at_pc_full_level(ilev,v2))*0.5_r8 &
               -1._r8*((real(mesh%edt_leng(ie),r8)**2)/6._r8)*der0 
...
#include <data_check.inc>
   real(r4), allocatable                :: my_scalar1_normal_flux_at_edge_full_level(:,:) ! also q
   real(r4), allocatable                :: my_scalar2_normal_flux_at_edge_full_level(:,:) ! also q
...
call t_startf("primal_normal_flux_at_edge_var2_5")
   do ie = 1, mesh%ne
      v1      = mesh%edt_v(1, ie)
      v2      = mesh%edt_v(2, ie)
      my_scalar2_normal_flux_at_edge_full_level(nlev,ie) = 0.5_r4*(scalar2_height_at_pc_full_level(nlev,v1)+scalar2_height_at_pc_full_level(nlev,v2))
   end do
