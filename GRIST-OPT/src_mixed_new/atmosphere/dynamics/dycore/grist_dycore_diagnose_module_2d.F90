...
!----------------------------------------------------------------------------
 ...
 module grist_dycore_diagnose_module_2d
  ...
  use grist_dycore_gcd_recon_module_2d_mixed, only: divergence_operator_2d_r8        , &
...
! local
    ...
    integer(i4)                        :: ilev
        ...
        call divergence_operator_2d_r8(mesh, dycoreVarEdgeFull%scalar_normal_velocity_n%f, &
