module grist_dycore_ref_atmos_mixed

! para
    use grist_constants,      only: i4, r8, rearth, rdry, cp, one, r4 => ns
  ...
  ! vert
    ...
    use grist_dycore_module_vars_control_mixed, only: eta_full_a, eta_full_b, eta_face_a, eta_face_b
  ! dycore
...
call t_startf("grist_dycore_ref_atmos_create_ptb_copy_1")
!$omp target
...
!$omp end target
   call t_stopf("grist_dycore_ref_atmos_create_ptb_copy_1")

   call t_startf("grist_dycore_ref_atmos_create_ptb_copy_2")
...
!$omp end parallel workshare
!$omp end target
          call t_stopf("grist_dycore_ref_atmos_create_ptb_copy_2")

          call t_startf("grist_dycore_ref_atmos_create_ptb_copy_3")
...
!$omp end parallel workshare
!$omp end target
            call t_stopf("grist_dycore_ref_atmos_create_ptb_copy_3")


            call t_startf("grist_dycore_ref_atmos_create_ptb_copy_4")
!$omp target
!$omp parallel workshare
           scalar_delp_at_pc_full_level_ptb(:,:)  =         dycoreVarCellFull%scalar_delp_np1%f_r4(:,:)-    dycoreVarCellFull%scalar_delhp_np1%f(:,:)
!$omp end parallel workshare
!$omp end target
           call t_stopf("grist_dycore_ref_atmos_create_ptb_copy_4")
...
end module grist_dycore_ref_atmos_mixed