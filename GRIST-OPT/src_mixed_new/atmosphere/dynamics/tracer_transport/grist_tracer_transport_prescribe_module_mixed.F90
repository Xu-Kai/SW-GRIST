module grist_tracer_transport_prescribe_module_mixed
    ...
    use grist_constants,                        only: i4, r8, pi, day2sec, rearth, p00, gravity, rdry, zero
    use grist_data_types,                       only: scalar_1d_field, scalar_2d_field, exchange_field_list_2d
    use grist_domain_types,                     only: global_domain
    use grist_nml_module,                       only: ntracer, testcase, nlev, nlevp, use_streamf
...
!
  subroutine tracer_transport_prescribe_ambient_r8(mesh, time, testcase)
!
! io
!
...
! presribed generalized vertical velocity
   ...
   return
  end subroutine tracer_transport_prescribe_ambient_r8
