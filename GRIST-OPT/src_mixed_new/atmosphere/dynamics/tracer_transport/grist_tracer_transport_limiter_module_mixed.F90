...
call t_startf("tracer_transport_hori_flux_limiter_fct_target_5")
!$omp target
...
!$omp end parallel 
!$omp end target
call t_stopf("tracer_transport_hori_flux_limiter_fct_target_5")
!
![3] compute limited flux at edge
!
call t_startf("tracer_transport_hori_flux_limiter_fct_target_6")
!$omp target
...
!$omp end parallel 
!$omp end target
call t_stopf("tracer_transport_hori_flux_limiter_fct_target_6")
