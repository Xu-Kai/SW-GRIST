...
! local
        ...
        case (1)  ! 1st-order upwind flux
call t_startf("tracer_transport_normal_flux_at_edge_target_r8_1")
!$omp target
!$omp parallel  private(ie,v0,v1,v0v1,flag,ilev,wind_edge,itracer)  
!$omp do
        do ie = 1, mesh%ne
...
!$omp end parallel 
!$omp end target
call t_stopf("tracer_transport_normal_flux_at_edge_target_r8_1")
        case(33)  ! purely upwind O3
call t_startf("tracer_transport_normal_flux_at_edge_target_r8_2")
!$omp target
!$omp parallel  private(ie,v0,v1,v0v1,flag,ilev,wind_edge,mark,v_upwind,itracer,der0,part1,part2)    
!$omp do 
            do ie = 1, mesh%ne
...
!$omp end parallel 
!$omp end target
call t_stopf("tracer_transport_normal_flux_at_edge_target_r8_2")
