...
! data
    ...
    use grist_nml_module,   only: physpkg
    implicit none

contains
   subroutine tracer_transport_check_mxrt_r8(mesh, scalar_tracer_mxrt_at_pc_full_level_n,called_env)
! io
     use omp_lib
...
! local
     ...
     integer(i4)     :: ii
        ...
        nsum = 0
call t_startf("tracer_transport_check_mxrt_target_r8")
...
!$omp end parallel
!$omp end target
     call t_stopf("tracer_transport_check_mxrt_target_r8")
#ifndef SEQ_GRIST
      ...
      return
    end subroutine tracer_transport_check_mxrt_r8
