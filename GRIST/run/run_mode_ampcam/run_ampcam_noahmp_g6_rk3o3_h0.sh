...
export mypath=`pwd`
export outdir=${mypath}/Reg-A20.9.1-cam5phys_v3_${glevel}-hadv${hadv}-hnrk${hnrk}-vadv${vadv}-vnrk${vnrk}/
mkdir ${outdir}
cd ${outdir}

cp /THL8/home/zhangyi/grist/run/bin/ParGRIST-amp-cam5-real.exe      ${outdir}/par.exe
cp /THL8/home/zhangyi/grist/inputdata/noahmp_data/*                 ${outdir}
cp /THL8/home/zhangyi/grist/run/ampcamphys_v3/configuration/grist_camphys.nml ${outdir}
...
EOF
cat>batch.sh<<EOF
#yhbatch -N ${nnode} -n ${nproc} -p TH_HPC3N run.sh
