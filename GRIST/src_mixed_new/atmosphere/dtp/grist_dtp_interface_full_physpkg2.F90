...
! local
    ...
    real(r8)                            :: scalar_vs_at_pc_surface  (ncell)
        ...
        nlevp = nlev+1
        call clock_begin(clock_phypkg1)
!
! prepare data
!
...
#endif
        call clock_end(clock_phypkg2)
        call clock_begin(clock_wrfpkg_ac)
! set albedo, not used in fact
       ...
       mesh%nv = mesh%nv_compute
        call clock_end(clock_wrfpkg_ac)

       call clock_begin(clock_phypkg3)
!----------------------------------------------------------------------
