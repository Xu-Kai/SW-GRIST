...
!
...
#ifdef AMIPW_PHYSICS
      case('AMIPW_PHYSICS')
      call clock_begin(clock_coup_tend1)
#ifdef MIXCODE
      ...
      !   dycoreVarCellFull%scalar_mpressure_n%f   = dycoreVarCellFull%scalar_mpressure_n%f_r4
        ...
        tracerVarCellFull%scalar_tracer_mxrt_n%f = tracerVarCellFull%scalar_tracer_mxrt_n%f_r4
#endif
      call clock_end(clock_coup_tend1)
      call clock_begin(clock_coup_wrfrun)
...
! obtain tendency for compound variables
!
   call clock_end(clock_coup_wrfrun)
   call clock_begin(clock_coup_tend2)
          ptend_f2%tend_mass_pt_at_pc_full_level%f = ptend_f2%tend_potential_temp_at_pc_full_level%f*&
                                                     dycoreVarCellFull%scalar_delhp_n%f
          ...
          ptend_f2%tend_www_at_pc_face_level%f     = zero
   call clock_end(clock_coup_tend2)
...
! F2 physics
      ...
      call clock_end(clock_coup1)

!
! exchange data
!
#ifndef SEQ_GRIST
         call clock_begin(clock_coup_exch)
         ...
         call clock_end(clock_coup_exch)
#endif
         call clock_begin(clock_coup2)
!
