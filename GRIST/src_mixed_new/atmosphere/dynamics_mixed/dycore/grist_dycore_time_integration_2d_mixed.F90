...
!
     ...
     integer(i4) :: clock_fnlrk1, clock_fnlrk2, clock_fnlrk3, clock_mpi, clock_mas1, clock_mas2, clock_ptm1, clock_ptm2, clock_updmpi
...
!$omp end parallel
...
#endif
#ifndef SEQ_GRIST
        call clock_end(clock_mas1)
#endif

#ifndef SEQ_GRIST
        call clock_begin(clock_mpi)
        ...
        call clock_end(clock_mpi)
#endif
        call clock_begin(clock_mas2)
!
...
! init array
      ...
      clock_mpi = clock_id('int_mpi')
      clock_mas1 = clock_id('mas1')
      clock_mas2 = clock_id('mas2')
      clock_ptm1 = clock_id('ptm1')
      clock_ptm2 = clock_id('ptm2')
      clock_updmpi = clock_id('update_mpi')
#endif
