...
!  to obtain the proper contribution.
         ...
         do ig = 1, ng3
            ...
            taug(ngs2+ig,lay) = tau_major + tau_major1 &
                 + tauself + taufor &
                 + adjcoln2o*absn2o
            fracs(ngs2+ig,lay) = fracrefa(ig,jpl) + fpl * &
...
!  to obtain the proper contribution.
         ...
         do ig = 1, ng3
            ...
            taug(ngs2+ig,lay) = speccomb * &
                ...
                + taufor &
                + adjcoln2o*absn2o
            fracs(ngs2+ig,lay) = fracrefb(ig,jpl) + fpl * &
      ...
      do lay = 1, laytrop
         ...
         do ig = 1, ng4
            ...
            taug(ngs3+ig,lay) = tau_major + tau_major1 &
                 + tauself + taufor
            fracs(ngs3+ig,lay) = fracrefa(ig,jpl) + fpl * &
                 (fracrefa(ig,jpl+1)-fracrefa(ig,jpl))
         enddo
      enddo
      ...
      do lay = laytrop+1, nlayers
         ...
         do ig = 1, ng4
            taug(ngs3+ig,lay) =  speccomb * &
                ...
                fac011 * absb(ind1+5,ig) + &
                fac111 * absb(ind1+6,ig))
            fracs(ngs3+ig,lay) = fracrefb(ig,jpl) + fpl * &
                (fracrefb(ig,jpl+1)-fracrefb(ig,jpl))
         enddo
      ...
      do lay = 1, laytrop
         ...
         do ig = 1, ng5
            ...
            taug(ngs4+ig,lay) = tau_major + tau_major1 &
                 ...
                 + abso3*colo3(lay) &
                 + wx(1,lay) * ccl4(ig)
            fracs(ngs4+ig,lay) = fracrefa(ig,jpl) + fpl * &
                 (fracrefa(ig,jpl+1)-fracrefa(ig,jpl))
         enddo
      enddo
      ...
      do lay = laytrop+1, nlayers
         ...
         do ig = 1, ng5
            taug(ngs4+ig,lay) = speccomb * &
                ...
                fac111 * absb(ind1+6,ig))  &
                + wx(1,lay) * ccl4(ig)
            fracs(ngs4+ig,lay) = fracrefb(ig,jpl) + fpl * &
                (fracrefb(ig,jpl+1)-fracrefb(ig,jpl))
         enddo
      enddo
...
!  to obtain the proper contribution.
         ...
         do ig = 1, ng7
            ...
            taug(ngs6+ig,lay) = tau_major + tau_major1 &
                 + tauself + taufor &
                 + adjcolco2*absco2
            fracs(ngs6+ig,lay) = fracrefa(ig,jpl) + fpl * &
                 (fracrefa(ig,jpl+1)-fracrefa(ig,jpl))
         enddo
      enddo
...
! for o3.  Revised to apply weighting for g-point reduction in this band.
         ...
         taug(ngs6+6,lay)=taug(ngs6+6,lay)*0.92_r8
         taug(ngs6+7,lay)=taug(ngs6+7,lay)*0.88_r8
         taug(ngs6+8,lay)=taug(ngs6+8,lay)*1.07_r8
         taug(ngs6+9,lay)=taug(ngs6+9,lay)*1.1_r8
         taug(ngs6+10,lay)=taug(ngs6+10,lay)*0.99_r8
         taug(ngs6+11,lay)=taug(ngs6+11,lay)*0.855_r8
...
!  to obtain the proper contribution.
         ...
         do ig = 1, ng9
            ...
            taug(ngs8+ig,lay) = tau_major + tau_major1 &
                 + tauself + taufor &
                 + adjcoln2o*absn2o
            fracs(ngs8+ig,lay) = fracrefa(ig,jpl) + fpl * &
                 (fracrefa(ig,jpl+1)-fracrefa(ig,jpl))
         enddo
      enddo
      ...
      do lay = 1, laytrop
         ...
         do ig = 1, ng12
            ...
            taug(ngs11+ig,lay) = tau_major + tau_major1 &
                 + tauself + taufor
            fracs(ngs11+ig,lay) = fracrefa(ig,jpl) + fpl * &
                 (fracrefa(ig,jpl+1)-fracrefa(ig,jpl))
         enddo
      enddo
...
! Upper atmosphere loop
      do lay = laytrop+1, nlayers
         do ig = 1, ng12
            taug(ngs11+ig,lay) = 0.0_r8
            fracs(ngs11+ig,lay) = 0.0_r8
         enddo
      enddo
...
!  to obtain the proper contribution.
         ...
         do ig = 1, ng13
            ...
            taug(ngs12+ig,lay) = tau_major + tau_major1 &
                 ...
                 + adjcolco2*absco2 &
                 + colco(lay)*absco
            fracs(ngs12+ig,lay) = fracrefa(ig,jpl) + fpl * &
                 (fracrefa(ig,jpl+1)-fracrefa(ig,jpl))
         enddo
      enddo
      ...
      do lay = 1, laytrop
         ...
         do ig = 1, ng15
            ...
            taug(ngs14+ig,lay) = tau_major + tau_major1 &
                 + tauself + taufor &
                 + taun2
            fracs(ngs14+ig,lay) = fracrefa(ig,jpl) + fpl * &
                 (fracrefa(ig,jpl+1)-fracrefa(ig,jpl))
         enddo
      enddo
...
! Upper atmosphere loop
      do lay = laytrop+1, nlayers
         do ig = 1, ng15
            taug(ngs14+ig,lay) = 0.0_r8
            fracs(ngs14+ig,lay) = 0.0_r8
         enddo
      enddo
      ...
      do lay = 1, laytrop
         ...
         do ig = 1, ng16
            ...
            taug(ngs15+ig,lay) = tau_major + tau_major1 &
                 + tauself + taufor
            fracs(ngs15+ig,lay) = fracrefa(ig,jpl) + fpl * &
                 (fracrefa(ig,jpl+1)-fracrefa(ig,jpl))
         enddo
      enddo
