...
! longitude loop
!!!$omp parallel private(i,k,rho1d,dorrsw,coszrs,Pw1D,Tw1D,O31D,T1D,P1D,DZ1D,CLDFRA1D,qndrop1d,predicate,QR1D,QG1D,qs1d,qc1d,qi1d,QV1D,ncol,nlay,icld,inflgsw,iceflgsw,liqflgsw,recloud1D,reice1D,idx_rei,corr,tem2,tem3,tem1,coszen,scon,dyofyr,adjes,tsfc,play,plev,pdel,tlay,tlev,h2ovmr,co2vmr,o2vmr,ch4vmr,n2ovmr,o3mmr,o3vmr,asdir,asdif,aldir,aldif,asmcld,fsfcld,clwpth,reice,ciwpth,rel,rei,pcols,pver,gravmks,landfrac,landm,snowh,icefrac,gicewp,gliqwp,cicewp,cliqwp,snow_mass_factor,resnow1d,gsnowp,csnowp,pi,third,rhoh2o,relconst,lwpmin,reliq,cswpth,res,taucld,ssacld,cldfrac,iplon,irng,permuteseed,cldfmcl,ciwpmcl,clwpmcl,cswpmcl,reicmcl,relqmcl,resnmcl,taucmcl,ssacmcl,asmcmcl,fsfcmcl,tauaer,ssaaer,asmaer,wavemid,ang,slope,ecaer,na,swuflx,swdflx,swhr,swuflxc,swdflxc,swhrc,aer_opt,sibvisdir,sibvisdif,sibnirdir,sibnirdif,swdkdir,swdkdif,tten1d) 
