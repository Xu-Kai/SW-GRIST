...
!
      ...
      REAL,     DIMENSION( ims:ime )                             , &
                INTENT(OUT)     ::                      U10,V10, &
                                                TH2,T2,Q2,LH
      REAL,     DIMENSION( ims:ime ), intent(inout) :: QSFC ! yiz modify for grist
...
!(yiz for grist: noahmp-lsm has some ill points? for this qsfc, 
! use here for all fluxes, differences are limited but avoid abnormal)
...
END MODULE module_sf_sfclay_v381
