...
!$omp end parallel 
      ...
      do ie = 1, mesh%ne
         ...
         icell2    = mesh%edt_v(2, ie)
         do ilev = 1, nlev
            dycoreVarEdgeFull%tend_normal_velocity_pgf%f(ilev,ie)  = dycoreVarEdgeFull%tend_normal_velocity_pgf%f(ilev,ie)-&
            0.1*mesh%edt_edpNr_edtTg(ie)*(dycoreVarSurface%tend_hpressure_cnty%f(icell2)-dycoreVarSurface%tend_hpressure_cnty%f(icell1))/(rearth*mesh%edt_leng(ie))
         end do
      end do
#endif
