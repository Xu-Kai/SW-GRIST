...
! hpe
  ...
  use grist_hpe_hydro_pgf,         only: calc_hpe_hpressure_face_level, calc_hpe_hydro, calc_hpe_get_full_mass
! data structure
...
!
   ...
   do ie = 1, mesh%ne_halo(1)
     ...
     do ilev = 1, nlev
        ...
        call random_number(pertval_v)
        pertval_u = 2_r8*pertval_u - 1_r8
        pertval_v = 2_r8*pertval_v - 1_r8
        utmp = utmp + 0.002*utmp*pertval_u
        vtmp = vtmp + 0.002*vtmp*pertval_v
#endif
