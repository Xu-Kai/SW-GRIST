!===============================================================================
!
!  Created by LiXiaohan on 19/08/16, adopted from CAM5
!
!     Ice nucleation code.
!
!===============================================================================
...
use grist_wv_saturation,  only: svp_water, svp_ice
...
subroutine nucleati(  &
   ...
   if(nuci.gt.9999._r8.or.nuci.lt.0._r8) then
      print*, 'Warning: incorrect ice nucleation number (nuci reset =0)'
      print*, ni, tair, relhum, wbar, nihf, niimm, nidep,deles,esi,dst_num,so4_num
      nuci=0._r8
   endif
